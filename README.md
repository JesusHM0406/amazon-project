...
<image src="./screenshots/amazon.png" alt="Amazon main page">
<image src="./screenshots/orderSummary.png" alt="Checkout page, orders section">
<image src="./screenshots/paymentSummary.png" alt="Checkout page, payment section">
<image src="./screenshots/orders.png" alt="Orders page">
<image src="./screenshots/tracking.png" alt="Traking page">
